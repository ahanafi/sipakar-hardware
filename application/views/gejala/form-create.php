		...
		<div class="row">
			<div class="col-md-6 grid-margin stretch-card">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url('gejala/create'); ?>" class="form-sample" method="POST"
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="id_gejala"
												   value="<?php echo $id_gejala; ?>" required
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="nama_gejala"
												   value="<?php echo set_value('nama_gejala'); ?>" required
												   autocomplete="off">
