			...
			<div class="col-md-8 grid-margin stretch-card">
				<div class="card">
					<div class="card-header header-sm d-flex justify-content-between align-items-center">
						<h4 class="card-title">Form Tambah Perangkat Keras</h4>
					</div>
					<div class="card-body">
						<form action="<?php echo base_url('jenis-perangkat-keras/create'); ?>" class="form-sample" method="POST"
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="id_perangkat_keras"
												   value="<?php echo $id_perangkat_keras; ?>" required
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="nama_perangkat_keras"
												   value="<?php echo set_value('nama_perangkat_keras'); ?>" required
												   autocomplete="off">
