		...
		<div class="row">
			<div class="col-md-7 grid-margin stretch-card">
				...
				<div class="card-header header-sm d-flex justify-content-between align-items-center">
					...
					<div class="card-body">
						<form action="<?php echo base_url('solusi/edit/' . $solusi->id_solusi); ?>" class="form-sample" method="POST">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label">ID Solusi</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" name="id_solusi" value="<?php echo $solusi->id_solusi; ?>" required autocomplete="off" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<textarea name="deskripsi" rows="5" placeholder="Deskripsi"
													  class="form-control"><?php echo $solusi->deskripsi; ?></textarea>
