		...
		<div class="row">
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url('kerusakan/edit/' . $id_kerusakan); ?>" class="form-sample" method="POST"
							...
							<div class="row">
								<div class="col-md-12">
										...
										<div class="col-sm-4">
											<select name="id_perangkat_keras" id="" class="form-control" required>
												...
												<?php foreach ($perangkat_keras as $p):?>
													<option <?php echo ($p->id_perangkat_keras == $kerusakan->id_perangkat_keras) ? "selected" : ""; ?> value="<?php echo $p->id_perangkat_keras; ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="nama_kerusakan" placeholder="Masukkan nama kerusakan"
												   value="<?php echo $kerusakan->nama_kerusakan; ?>" required
												   autocomplete="off">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<textarea name="solusi" id="solusi" required><?php echo $kerusakan->solusi; ?></textarea>
